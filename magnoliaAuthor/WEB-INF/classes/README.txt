...
This package contains:
   ...
   Magnolia Core 5.4.2
   magnolia-empty-webapp 5.4.2
   magnolia-empty-webapp 5.4.2
   Magnolia Internationalization Framework 5.4.2
   Magnolia Imaging Support Module 3.2.2
   Magnolia JAAS 5.4.2
   Magnolia Commenting Module 2.3.1
   Magnolia Form Module 2.3.1
   magnolia-module-forum 3.5
   Google Sitemap Module 2.3.1
   magnolia-module-groovy 2.4.1
   Magnolia Imaging Module 3.2.2
   Magnolia Inplace-templating Module 2.4.1
   Magnolia Legacy UI 5.3
   magnolia-module-mail 5.3
   magnolia-module-rssaggregator 2.4.1
   Magnolia Rendering 5.4.2
   Magnolia Templating 5.4.2
   Magnolia Templating for JSP 5.4.2
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.4.2.html
